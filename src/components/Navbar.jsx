...
const Navbar = () => {
  ...
  return <>
        <div className={`${showNavbar === true ? 'visible' : 'hidden'} fixed z-50 font-normal bg-slate-950 shadow-xl border-b-2 border-black w-screen py-2 lg:py-5 md:py-5 sm:py-2 ${loading === true ? 'animate-appear' : null}`}>
        <div className="flex flex-row-reverse lg:flex lg:flex-row md:flex md:flex-row-reverse sm:flex sm:flex-row-reverse px-8 lg:justify-around md:justify-between sm:justify-between justify-between items-center">
            <div className="flex justify-center"><div className="grid font-qwitcher_grypen font-bold text-4xl"><h1>Ak</h1></div></div>
                <ul className="hidden lg:flex md:hidden sm:hidden justify-around items-center gap-x-20 text-lg">
                    ...
                    <a href="#about"><li className="cursor-pointer hover:transition-transform hover:-translate-y-2 hover:border-cyan-400 hover:pb-1 hover:border-b-2 hover:duration-300 duration-300">About Me</li></a>
                    ...
                    <a href="#contact"><li className="cursor-pointer hover:transition-transform hover:-translate-y-2 hover:border-cyan-400 hover:pb-1 hover:border-b-2 hover:duration-300 duration-300">Contact Me</li></a>
                </ul>
            <button onClick={() => {setshowProfile(showProfile^1)}}><div className={`hidden lg:flex md:hidden sm:hidden w-32 cursor-pointer text-lg rounded-3xl border-2 border-cyan-400 p-1 justify-center hover:bg-cyan-400 hover:transition-transform hover:-translate-y-2 hover:duration-500 duration-500`}><h1>My Profile</h1></div></button>
            <div className="block text-white lg:hidden md:block sm:block hover:text-cyan-400 hover:transition-transform hover:-translate-y-1 hover:duration-500 cursor-pointer duration-500" onClick={controlDropdown}><IoMenu/></div>
            </div>
        </div>
        {showProfile === 1 ?                                                               /*52 48*/
